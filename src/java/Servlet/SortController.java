...
//        processRequest(request, response);
        ...
        LinkedHashMap<String, Product> hmProduct = cdb.getAllProductBySort(s, b);
        request.setAttribute("allProduct", hmProduct);
        request.setAttribute("allCategory", hmCategory);
        HashSet<String> category = new HashSet<>(Arrays.asList(new String[]{""}));
        HashSet<String> year = new HashSet<>(Arrays.asList(new String[]{""}));
